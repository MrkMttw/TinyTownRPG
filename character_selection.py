...
def character_selection_screen(SCREEN, tiles, bg, bg_width, BOY, GIRL, OUTLINE, BUTTON1, BUTTON2, ButtonClass, get_font, on_select_callback, back_callback):
    scroll = 0
    while True:
        ...
        # Buttons
        OPTIONS_BOY_SELECTED = ButtonClass(image=BUTTON1, pos=(240, 600), 
                              text_input="SELECT", font=get_font(40), 
                              base_color="BLACK", hovering_color="#FFE14D")
        
        OPTIONS_GIRL_SELECTED = ButtonClass(image=BUTTON1, pos=(590, 600), 
                              text_input="SELECT", font=get_font(40), 
                              base_color="BLACK", hovering_color="#FFE14D")
        
        OPTIONS_BACK = ButtonClass(image=BUTTON2, pos=(150, 70), 
...
def character_selected(SCREEN, tiles, bg, bg_width, get_font, BUTTON2, Button, main_menu):
    scroll = 0
    while True:
        OPTIONS_MOUSE_POS = pygame.mouse.get_pos()
        ...
        CHARACTER_SELECTED = get_font(80).render("CHARACTER HAS BEEN SELECTED", True, "Black")
        CHARACTER_SELECTED_RECT = CHARACTER_SELECTED.get_rect(center=(640, 260))
        SCREEN.blit(CHARACTER_SELECTED, CHARACTER_SELECTED_RECT)

        SELECTED_BACK = Button(image=BUTTON2, pos=(640, 500), 
                              text_input="BACK", font=get_font(30), 
                              base_color="Black", hovering_color="#FFE14D")
